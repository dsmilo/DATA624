...
ph_data <- read.csv("data/StudentData.csv", na.strings = c("", " "), stringsAsFactors = FALSE)
...
```{r eval-data}
# read in data
new_data <- read.csv("data/StudentEvaluation.csv", na.strings = c("", " "), stringsAsFactors = FALSE)
```
